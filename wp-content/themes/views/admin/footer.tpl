        ...
        <div class="sb-content">
          <div class="tab-navigation">
            <ul role="tablist" class="nav nav-tabs nav-justified">
              <li role="presentation"  class="active"><a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Settings</a></li>
            </ul>
          </div>
          <div class="tab-panel">
            <div class="tab-content">
              <div id="tab3" role="tabpanel" class="tab-pane tab-settings active">
...
$(function () {
     var str=location.href.toLowerCase();
        $('.left-sidebar-content ul li a').each(function() {
                if (str.indexOf(this.href.toLowerCase()) > -1) {
						$("li.active").removeClass("active");
                        $(this).parent().addClass("active"); 
                   }
              	 							}); 
		$('.sub-menu li.active').parents().each(function(){
