...
<head>
    ...
    <title>All Dashboard List</title>
        ...
        <div class="main-content container-fluid">
          ...
          <div class="col-xs-12 col-md-6 col-lg-3">
                        <div class="widget widget-tile">
                          <i style="font-size:20px" class="icon mdi mdi-face"></i>
                          <div class="data-info">
                            <div class="desc">New Users</div>
                            <div class="value"><span class="indicator indicator-equal mdi mdi-chevron-right"></span><span data-toggle="counter" data-end="113" class="number">3000</span>
                            </div>
                          </div>
                        </div>
            </div>
