<body >
<form name="loginform"  id="loginform" action="<?=base_url('/domain/'.$_GET['webname'].'/wp-login.php')?>" method="post" style="display:none;">
	<p>
	...
	<p class="submit">
		...
		<input type="hidden" name="redirect_to" value="<?=base_url('/domain/'.$_GET['webname'].'/wp-admin/')?>" />
